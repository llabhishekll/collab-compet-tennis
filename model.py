...
class Group():
    def __init__(self, num_agents, state_size, action_size, seed):
        ...
        self.agents = [Agent(self.memory, state_size, action_size, seed) for _ in range(num_agents)]
...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=HIDDEN_UNIT, fc2_units=HIDDEN_UNIT):
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=HIDDEN_UNIT, fc2_units=HIDDEN_UNIT):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
...
class Agent():
    ...
    def __init__(self, memory, state_size, action_size, seed):
        ...
        # Replay memory
        self.memory = memory # ReplayBuffer(action_size, BUFFER_SIZE, BATCH_SIZE, seed)
